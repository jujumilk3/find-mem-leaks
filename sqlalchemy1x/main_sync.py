...
if __name__ == "__main__":
    ...
    for _ in range(5):
        ...
        print(
            f"| sqlalchemy1x_sync_session | 1000000_operations | ✅ | {_ + 1} | "
            f"{result['memory_diff']} | {result['initial_memory']} | "
            f"{result['final_memory']} | {result['num_operations']} | "
            f"{result['create_ratio']} | {result['read_ratio']} | "
            f"{result['update_ratio']} | {result['delete_ratio']} |"
    ...
    for _ in range(5):
        ...
        print(
            f"| sqlalchemy1x_sync_session | create_heavy | ✅ | {_ + 1} | "
    ...
    for _ in range(5):
        ...
        print(
            f"| sqlalchemy1x_sync_session | read_heavy | ✅ | {_ + 1} | "
    ...
    for _ in range(5):
        ...
        print(
            f"| sqlalchemy1x_sync_session | update_heavy | ✅ | {_ + 1} | "
    ...
    for _ in range(5):
        ...
        print(
            f"| sqlalchemy1x_sync_session | delete_heavy | ✅ | {_ + 1} | "
