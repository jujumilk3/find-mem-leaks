    ...
    for i in tqdm(range(num_operations)):
        ...
        if operation == "create":
            ...
            if count_result:
                ...
                post = sync_session.scalar(stmt)
                if post:
                    stmt = select(Comment).where(Comment.post_id == post_id)
                    _ = sync_session.scalars(stmt).all()
...
if __name__ == "__main__":
    ...
    for _ in range(5):
        ...
        print(
            f"| sqlalchemy2x_sync_scoped_session | 10000_operations | ✅ | {_ + 1} | "
    ...
    for _ in range(5):
        ...
        print(
            f"| sqlalchemy2x_sync_scoped_session | create_heavy | ✅ | {_ + 1} | "
    ...
    for _ in range(5):
        ...
        print(
            f"| sqlalchemy2x_sync_scoped_session | read_heavy | ✅ | {_ + 1} | "
    ...
    for _ in range(5):
        ...
        print(
            f"| sqlalchemy2x_sync_scoped_session | update_heavy | ✅ | {_ + 1} | "
    ...
    for _ in range(5):
        ...
        print(
            f"| sqlalchemy2x_sync_scoped_session | delete_heavy | ✅ | {_ + 1} | "
